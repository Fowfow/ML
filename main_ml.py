...
data_analysis.bivariate_plot(dtf_tit, x="Age", y="Y", figsize=(20, 10), filename="ML/0_bivariate_age_y.png")
data_analysis.nan_analysis(dtf_tit, na_x="Cabin", y="Y", max_cat=20, figsize=(10,5), filename="ML/0_nan_analysis.png")
data_analysis.cross_distributions(dtf_tit, "Sex", "Age", "Y", filename="ML/0_cross_distrib_sex_age_y.png")
# plt.show()
